...
public:
	...
	*/
	...
	int GetEnd() const { return mStop; }

	void SetFrame(int idx)
	{
		assert(idx >= mStart && idx <= mStop);
		mCurrent = idx;
	}
};
...
{
private:
	ID3D11ShaderResourceView *mpTex = nullptr;
	MyD3D& mD3D;
	RECTF mTexRect;
	DirectX::SimpleMath::Vector2 scale;
	const TexCache::Data *mpTexData = nullptr;
	Animate mAnim;
...
public:
	...
	Sprite(MyD3D& d3d)
		...
		mD3D(d3d), mpTexData(nullptr), mAnim(*this)
	{}
